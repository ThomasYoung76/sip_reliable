...
private:
    ...
    static void * ThreadReg01(void * data);
    static void * ThreadReg02(void * data);
    static void * ThreadReg03(void * data);
    static void * ThreadReg04(void * data);
    static void * ThreadReg05(void * data);
private:
    pthread_t m_pthreadStruc01;
    pthread_t m_pthreadStruc02;
    pthread_t m_pthreadStruc03;
    pthread_t m_pthreadStruc04;
    pthread_t m_pthreadStruc05;
